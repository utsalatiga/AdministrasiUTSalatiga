-- 1. Tambahkan kolom no_kwitansi ke tabel pembayaran jika belum ada
ALTER TABLE pembayaran ADD COLUMN IF NOT EXISTS no_kwitansi TEXT;

-- 2. Update fungsi process_manual_payment untuk menerima parameter p_no_kwitansi dan menyimpannya ke tabel pembayaran
...
BEGIN
  ...
  -- 1. Kurangi deposit mahasiswa jika gap-nya ada
